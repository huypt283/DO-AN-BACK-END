...
public interface CustomerService {
    ...
    MessageResponse blockCustomer(Integer id) throws CustomException;

    //    active khách hàng
    MessageResponse activeCustomer(Integer id) throws CustomException;
    ...
    MessageResponse deleteCustomers(Integer id) throws CustomException;
}
